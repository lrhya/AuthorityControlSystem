...
<div class="login">
    ...
    <div class="login-top">
        ...
        <form id="login" action="user/do/login">
            <input type="text" name="loginAcct" value="User account" onfocus="this.value = '';"
                   onblur="if (this.value == '') {this.value = 'User account';}">
            <input type="text" name="userPswd" value="User password" onfocus="this.value = '';"
                   onblur="if (this.value == '') {this.value = 'User password';}">
        </form>
        <div class="forgot">
