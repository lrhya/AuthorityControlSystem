...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <div>
                <a class="navbar-brand" href="index.html" style="font-size: 32px;">AuthorityControlSystem</a>
            </div>
        </div>
    </div>
</nav>
...
<div class="container">
   ...
   <%--     <p>${requestScope.MESSAGE }</p>--%>
        ...
        <div class="form-group has-success has-feedback">
            <input type="password" name="userPswd" class="form-control" id="inputUserPassword" placeholder="请输入登录密码"
                   style="margin-top: 10px;">
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        </div>
        <button id="loginBtn"  class="btn btn-lg btn-success btn-block">登录</button>
    </form>
</div>
</body>
</html>