...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/statics/script/my-customer.js"></script>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="customer/query/for/search.html" class="form-inline" role="form" style="float: left;"
                          method="post">
                        ...
                        <table class="table  table-bordered">
                            ...
                            <c:if test="${!empty requestScope['PAGE-INFO'].list }">
                                <c:forEach items="${requestScope['PAGE-INFO'].list }"
                                           var="customer" varStatus="myStatus">
                                    <tr>
                                        <td>${myStatus.count }</td>
                                        <td><input customerId="${customer.id }" class="itemBox" type="checkbox"></td>
                                        <td>${customer.loginAcct }</td>
